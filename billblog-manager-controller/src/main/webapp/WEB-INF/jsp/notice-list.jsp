	...
	<div class="row navbar-fixed-top" id="nav"> 
		<div class="container" id="nav-con">
			...
			<div class="col-md-2 col-xs-9" id="logo">
				...
				<input id="hiddenId" type="hidden" value="${other_user_base_info.userId}">
			</div>
			<!-- 输入栏 -->
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1" id="top-bg-div">
				...
				<!-- 昵称 -->
				<div>
					<h3><a id="nicknameA" href="/billblog-manager-controller/weibocontroller/tohomepage.do?userId=${other_user_base_info.userId}">${other_user_base_info.userNickname}</a></h3>
					<p>
		...
		<div class="row" style="margin-top:20px;">
			<div class="col-md-offset-1 col-md-3 col-sm-offset-1 col-sm-3" id="left-div">
				...
				<div class="container-fluid">
					...
					<div class="col-xs-4">
						<div><a style="color:red;" href="/billblog-manager-controller/attentioncontroller/tonoticelistpage.do?userId=${other_user_base_info.userId}">关注</a></div>
						<div><a style="color:red;" href="/billblog-manager-controller/attentioncontroller/tonoticelistpage.do?userId=${other_user_base_info.userId}">${user_noticed_sum}</a></div>
					</div>
					<div class="col-xs-4">
						<div>
							<a href="/billblog-manager-controller/weibocontroller/tohomepage.do?userId=${other_user_base_info.userId}">微博</a>
						</div>
						<div>
							<a href="/billblog-manager-controller/weibocontroller/tohomepage.do?userId=${other_user_base_info.userId}">${weibo_sum}</a>
						</div>
					</div>
				</div>
				<!-- 等级信息 -->
			...
			<div>
				...
				<c:if test="${user_noticed_sum%5 eq 0}">
					<c:set var="pageNum" value="${user_noticed_sum/5}"></c:set>
				</c:if>
				<c:if test="${user_noticed_sum%5 ne 0}">
					<c:set var="pageNum" value="${1+user_noticed_sum/5}"></c:set>
				</c:if>
...
<script type="text/javascript" src="/billblog-manager-controller/resource/js/relative/notice-list.js"></script>
