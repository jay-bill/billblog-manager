	...
	//刷新页面即可获取
	function getFansListData(){
		var userId = $("#hiddenId").val();
		$.ajax({
			url:"/billblog-manager-controller/attentioncontroller/getfansuserlist.do",
			type:"get",
	 ...
	 * 直接点击页数
	 */
	function getFansListDataByNum(number){
		var userId = $("#hiddenId").val();
		$.ajax({
			url:"/billblog-manager-controller/attentioncontroller/getfansuserlist.do",
			type:"get",
